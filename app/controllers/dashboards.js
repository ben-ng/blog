var Dashboards = function () {
  ...
  this.main = function (req, resp, params) {
    var self = this;
    geddy.model.Post.all({isPublished: false}, {sort: {publishedAt: 'ASC', updatedAt: 'ASC', createdAt: 'ASC'}}, function (err, drafts){
    geddy.model.Post.all({isPublished: true}, {sort: {publishedAt: 'ASC', createdAt: 'ASC'}}, function (err, posts) {
